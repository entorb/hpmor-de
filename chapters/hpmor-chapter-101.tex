...
\lettrine{H}{arry} stand keuchend inmitten eines kurzzeitig verwüsteten Kreises mitten im Wald, der mehr Zerstörung enthielt, als ein normaler Erstklässler allein hätte erreichen können. Der Durchtrennungszauber würde keinen Baum zu Fall bringen, also hatte er angefangen, Querschnitte durch das Holz teilweise zu verwandeln. Es hatte nicht alles herausgelassen was in ihm war, einen kleinen Kreis von Bäumen zu fällen hatte ihn nicht besser fühlen lassen, all die Emotionen waren immer noch da, aber während er Bäume zerstörte, dachte er wenigstens nicht darüber nach, dass die Gefühle nicht herausgelassen werden konnten.
...
„Ein seltsames Wort, \emph{Unschuld}. Es bedeutet Mangel an Wissen, wie die Unschuld eines Kindes, und bedeutet auch Mangel an Schuld. Nur wer völlig unwissend ist, kann keine Verantwortung für die Folgen seines Handelns übernehmen. Er weiß nicht, was er tut, und kann daher ohne schädliche Absicht sein; so sagt es dieses Wort.“
...
Harrys Augen flackerten zu der Speerspitze, und ihm wurde klar, dass er seinen Zeitumkehrer hätte ergreifen sollen, als er den Zentauren sah. Wenn Harry jetzt versuchte, unter seinen Umhang zu greifen, könnte der Speer ihn vorher treffen, wenn der Zentaur schnell genug war.
...
„Vielleicht“, sagte der Zentaur nachdenklich. Er senkte den Kopf.
...
Zu diesem Zeitpunkt war das Unheilsgefühl, jene fast greifbar in der Luft liegende Macht, schon wieder nähergekommen.
...
„Nun“, sagte der Mann im schwarzen Umhang nachdenklich,
„\emph{du} musstest mitten in der Nacht im Verbotenen Wald einen lauten Wutanfall bekommen, und ich musste gerade außerhalb deines Wahrnehmungsbereichs bleiben und Wache halten. Man lässt einen Schüler nicht allein im Verbotenen Wald. Das sollte im Nachhinein klar sein.“
...
„Sie — sie haben ihn getötet, das war Avada Kedavra —“
...
„Ja“, antwortete Harry nach langem Zögern.
„Aus meiner Sicht, Herr Schulleiter, sind die Dinge in Hogwarts endlich, \emph{endlich} normal. So sollte es sein, wenn vier Kinder nachts in den Verbotenen Wald geschickt werden. Es sollte einen riesigen Aufruhr geben, Polizisten sollten auftauchen und der Verantwortliche sollte entlassen werden.“

% “You believe it is good,” Dumbledore said quietly, “that the man who you call responsible was, as you put it, sacked.”
„Du findest es gut“, sagte Dumbledore leise, „dass der Mann, den du für verantwortlich hältst, entlassen wurde, wie du es ausdrückst.“
...
„Argus Filch ist ein Squib. Seine Arbeit in Hogwarts ist alles, was er hat. Hatte, vielmehr.“
...
„Der Zweck einer Schule ist nicht, Arbeit für ihre Angestellten bereitzustellen. Ich weiß, dass sie wahrscheinlich mehr Zeit um Filch herum verbracht haben als um jeden einzelnen Schüler, aber das sollte nicht dazu führen, dass Filchs Innenleben in ihren Gedanken wichtiger wird. Schüler haben auch ein Innenleben.“
...
„Wie Mr~Hagrid, den ich, wie sie bemerkt haben, nicht als bösartig, sondern nur als vergesslich bezeichnen würde. Ich war einverstanden, dass Mr~Hagrid hier arbeitet, solange er niemanden mehr in den Verbotenen Wald mitnimmt.“
...
„Ich hatte gedacht, dass Rubeus, nachdem er entlastet worden war, nach Silvanus' Weggang von dieser Position Pflege magischer Geschöpfe unterrichten könnte. Aber ein Großteil dieses Unterrichts findet im Verbotenen Wald statt. Also auch das soll nicht sein, infolge deines Vorgehens.“
...
„Vielleicht.“ Harry starrte weiter auf seine Knie.
„Oder vielleicht ist es noch schlimmer als das. Herr Schulleiter, was bedeutet es, wenn ein Zentaur mich nicht mag?“
...
„Es war etwas spezifischer als das.“
