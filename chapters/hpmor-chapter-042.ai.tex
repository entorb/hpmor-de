...
\lettrinepara[ante=„]{R}{omantisch?}“, sagte Hermione.
„Sie sind beide \emph{Jungs}!“
...
„Nein“, sagte ein älteres Slytherin-Mädchen, das Hermine nicht erkannte, „es stimmt, sie müssen heimlich heiraten, und wenn sie jemals entdeckt werden, werden sie gemeinsam auf dem Scheiterhaufen verbrannt. Und wenn du ein Mädchen bist, das es romantisch findet, verbrennen sie dich auch.“
...
Im Moment jedoch, vor den großen Türen des Schlosses inmitten der Hälfte der weiblichen Bevölkerung von Hogwarts stehend, begann Hermine zu vermuten, dass hier \emph{Dinge} vor sich gingen, die sie nicht verstand und von denen sie verzweifelt hoffte, dass keiner ihrer Generalkollegen jemals davon erfahren würde.

\later

% You couldn’t really see the details from up there, just the general fact of a sea of expectant female faces.
Man konnte die Details von da oben nicht wirklich erkennen, nur die allgemeine Tatsache, dass es ein Meer von erwartungsvollen weiblichen Gesichtern gab.
...
Harry hatte eine ganze Reihe von Büchern gelesen, die er nicht lesen sollte, ganz zu schweigen von ein paar \emph{Klitterer}-Schlagzeilen.

% “Boy-Who-Lived gets Draco Malfoy pregnant?” said Harry.
„Junge-der-überlebte macht Draco Malfoy schwanger?“, sagte Harry.

% “Okay, you \emph{do} know what this is about,” said Draco. “I thought Muggles hated that?”
„Okay, du \emph{weißt} also, worum es hier geht“, sagte Draco.
...
„Aber, ähm, sind wir nicht ein bisschen \emph{zu jung} dafür?“
...
Sie gingen schweigend zum Rand des Daches.
...
Harrys Verstand machte eine Blitzkalkulation und wog die Faktoren ab, ob es zu früh war …
...
Draco sah auf den Rand des Daches und verzog das Gesicht.
„Das wird viel schwieriger sein, es absichtlich zu tun als durch Zufall, nicht wahr?“

\later

% Harry’s other hand held the roof in a reflexively terrified grip, his fingers white on the cold, cold stone.
Harrys andere Hand umklammerte das Dach in einem reflexartig verängstigten Griff, seine Finger weiß auf dem kalten, kalten Stein.
...
Man konnte mit dem Verstand wissen, dass man den Federfalltrank getrunken hatte. Es mit dem Unterbewusstsein zu wissen, war etwas völlig anderes.

% It was every bit as scary as Harry had thought it might have been for Hermione, which was justice.
Es war genauso beängstigend, wie Harry gedacht hatte, dass es für Hermine gewesen sein könnte, was nur gerecht war.
...
„Draco“, sagte Harry, seine Stimme zu kontrollieren war nicht einfach, aber die Ravenclaw-Mädchen hatten ihnen ein Drehbuch gegeben,
...
Es gab einen kurzen Moment, in dem Harrys Magen versuchte, in seinen Hals zu springen, und sein Körper verzweifelt versuchte, sich zu orientieren, obwohl es keine Möglichkeit dazu gab.
...
Es gab einen kurzen Moment, in dem Harry spürte, wie der Federfalltrank wirkte und ihn zu verlangsamen begann, ein taumelndes, dämpfendes Gefühl.

% And then something \emph{pulled} on Harry and he accelerated downward again \emph{faster than gravity—}
Und dann \emph{zerrte} etwas an Harry, und er beschleunigte wieder nach unten, \emph{schneller als die Schwerkraft} —
...
Harrys Mund hatte sich bereits geöffnet und zu schreien begonnen, während ein Teil seines Gehirns versuchte, sich etwas Kreatives einfallen zu lassen, ein anderer Teil berechnete, wie viel Zeit ihm noch blieb, um kreativ zu sein, und ein winziger Restteil seines Gehirns bemerkte, dass er die Berechnung der verbleibenden Zeit nicht einmal beenden würde, bevor er auf dem Boden aufschlug —
...
Harry versuchte verzweifelt, seine Hyperventilation zu kontrollieren, und es half ihm nicht, das Geschrei all der Mädchen zu hören, die jetzt in Haufen auf dem Boden und übereinander lagen.
...
„Meine Güte“, sagte der unbekannte Mann, der mit der altmodisch aussehenden Kleidung und dem leicht vernarbten Gesicht, der Harry in seinen Armen hielt.
„Von all den Arten, wie ich mir vorgestellt habe, dass wir uns eines Tages wiedersehen könnten, habe ich nicht erwartet, dass du aus dem Himmel fällst.“

% Harry remembered the last thing he’d seen, the falling body, and managed to gasp, “Professor…Quirrell…”
Harry erinnerte sich an das Letzte, was er gesehen hatte, den fallenden Körper, und brachte keuchend hervor:
„Professor … Quirrell …“
...
„Er wird in ein paar Stunden wieder in Ordnung sein“, sagte der unbekannte Mann, der Harry hielt.
„Er ist nur erschöpft. Ich hätte nicht gedacht, dass das möglich ist … er muss \emph{zweihundert Schüler} niedergestreckt haben, nur um sicherzugehen, dass er denjenigen erwischt, der dich verflucht hat …“
...
Harry balancierte sich vorsichtig aus und nickte dem Mann zu.
...
Der Mann half ihm, wieder aufzustehen. Dabei achtete er stets darauf, zwischen Harry und den Mädchen zu stehen, die sich jetzt vom Boden aufrappelten, und blickte ständig in ihre Richtung.

% “Harry,” the man said quietly, and very seriously, “do you have any idea which of these girls might have wanted to kill you?”
„Harry“, sagte der Mann leise und sehr ernst, „hast du eine Ahnung, welches dieser Mädchen dich töten wollte?“
...
Diesmal war es der unbekannte Mann, der fast umkippte, auf seinem Gesicht stand blankes Entsetzen.

% Professor Quirrell was already sitting up from where he’d fallen on the grass.
Professor Quirrell saß bereits auf, dort wo er ins Gras gefallen war.

% “Good heavens!” gasped the man. “You shouldn’t be—”
„Meine Güte!“, keuchte der Mann.
„Sie sollten nicht —“
...
„Mr~Lupin, Ihre Bedenken sind fehl am Platz. Kein Zauberer, egal wie mächtig, wirkt einen solchen Zauber allein durch Stärke. Man muss es tun, indem man \emph{effizient} ist.“
...
„Ich hätte es selbst vorhersehen sollen“, sagte Professor Quirrell, seine Stimme scharf vor Missbilligung.
„Einige Mädchen versuchten, Mr~Potter in ihre eigenen, jeweiligen Arme zu rufen. Ich nehme an, jede dachte für sich, sie sei sanft.“
...
„Betrachten Sie es als eine Lektion in Vorbereitung, Mr~Potter“, sagte Professor Quirrell.
„Hätte ich nicht \emph{darauf bestanden}, dass es mehr als einen erwachsenen Zeugen für dieses kleine Ereignis gibt und dass \emph{wir beide} unsere Zauberstäbe gezückt haben, wäre Mr~Lupin nicht in der Lage gewesen, Ihren Sturz danach zu verlangsamen, und Sie wären schwer verletzt worden.“
...
„Ich stelle \emph{Ihnen} Remus Lupin vor, der vorübergehend hier ist, um Schüler im Patronus-Zauber zu unterrichten. Obwohl mir gesagt wurde, dass ihr beide euch bereits getroffen habt.“
...
Mr~Lupins temporäres Büro war ein kleiner Steinraum mit einem kleinen Holzschreibtisch, und Harry konnte nichts von dem sehen, worauf Mr~Lupin saß, was darauf hindeutete, dass es ein kleiner Hocker war, genau wie der vor seinem Schreibtisch. Harry vermutete, dass Mr~Lupin nicht lange in Hogwarts sein würde oder dieses Büro viel benutzen würde, und so hatte er den Hauselfen gesagt, sie sollten sich keine Mühe machen. Es sagte etwas über eine Person aus, dass er versuchte, die Hauselfen nicht zu stören. Konkret hieß es, dass er nach Hufflepuff sortiert worden war, da Hermine nach bestem Wissen und Gewissen die einzige Nicht-Hufflepuffin war, die sich darum sorgte, Hauselfen zu stören. (Harry selbst fand ihre Bedenken ziemlich albern. Wer auch immer Hauselfen erschaffen hatte, war natürlich unsagbar böse gewesen; aber das bedeutete nicht, dass Hermine \emph{jetzt} das Richtige tat, indem sie fühlenden Wesen die Plackerei verweigerte, für die sie geschaffen worden waren.)
...
„Bitte setz dich, Harry“, sagte der Mann leise. Seine formellen Umhänge waren von minderwertiger Qualität, nicht ganz zerschlissen, aber im Laufe der Zeit sichtbar abgenutzt auf eine Weise, die einfache Reparaturzauber nicht beheben konnten; \emph{schäbig} war das Wort, das einem in den Sinn kam. Und trotzdem umgab ihn irgendwie eine Würde, die nicht durch feine und teure Umhänge erreicht werden konnte, die nicht zu feinen Gewändern \emph{gepasst} hätte, die das ausschließliche Eigentum der Schäbigen war. Harry hatte von Demut \emph{gehört}, aber er hatte noch nie zuvor wahre Demut gesehen — nur die zufriedene Bescheidenheit der Leute, die dachten, es sei Teil ihres Stils und wollten, dass man es bemerkte.

% Harry took a seat on the small wooden stool in front of Mr~Lupin’s short desk.
Harry setzte sich auf den kleinen Holzhocker vor Mr~Lupins niedrigem Schreibtisch.
...
„Lassen Sie es mich wissen, wenn Sie jemals etwas Unmögliches erledigt haben wollen.“
...
„Ah“, sagte Herr Lupin. Und dann wieder „Ah“. Er schien ziemlich heftig zu blinzeln.
„Ich … das ist gut zu hören, Harry, Dumbledore wollte keinem von uns sagen, wo du warst … Ich hatte Angst, dass er vielleicht dachte, du solltest böse Stiefeltern haben oder so etwas …“
...
„Eine große Bitte“, sagte Mr~Lupin. Er wischte sich mit einer Hand über die Stirn.
„Nun, fangen wir am Anfang an. Als du geboren wurdest, war James so glücklich, dass er seinen Zauberstab eine ganze Woche lang nicht berühren konnte, ohne dass er golden leuchtete. Und auch danach, wann immer er dich hielt oder sah, wie Lily dich hielt, oder nur an dich dachte, passierte es wieder —“
...
Schließlich brachte Harry genug Mut auf, um die kritische Frage zu stellen, während Remus mitten in einem ausgedehnten Diskurs über die Wunder von James’ Quidditch war, den Harry nicht direkter unterbrechen konnte.
...
„als James einen dreifachen \emph{Mulhanney-Sturzflug} mit \emph{extra Rückwärtsdrall} hinlegte! Die ganze Menge tobte, sogar einige der Hufflepuffs jubelten —“

% \emph{I guess you had to be there,} Harry thought—not that being there would have helped in any way—and said, “Mr~Lupin?”
\emph{Ich schätze, man hätte dabei sein müssen}, dachte Harry — nicht, dass es irgendwie geholfen hätte — und sagte:
„Mr~Lupin?“

% Something about Harry’s voice must have reached the man, because he stopped in mid-sentence.
Irgendetwas an Harrys Stimme musste den Mann erreicht haben, denn er stoppte mitten im Satz.

% “Was my father a bully?” said Harry.
„War mein Vater ein Tyrann?“ sagte Harry.
...
„Für eine kurze Zeit“, sagte Remus.
„Er ist aber bald danach darüber hinweggewachsen. Wo hast du das gehört?“
...
Harry antwortete nicht, er versuchte, an etwas Wahres zu denken, das möglichen Verdacht ablenken würde, aber er dachte nicht schnell genug.
...
„Ich kann mir denken, wer es war.“ Das schwach vernarbte Gesicht verzog sich vor Missbilligung.
„Was für eine Sache, das zu erzählen —“
...
„Ein schwieriges Elternhaus oder so etwas in der Art? Oder war er einfach … von Natur aus gemein?“ \emph{Kalt?}
...
„Harry“, sagte Remus, „man kann seinen Vater nicht nach dem beurteilen, was er als kleiner Junge getan hat!“
...
„Bitte erzählen Sie mir alles, was Sie darüber wissen, warum er es getan hat, auch wenn es nicht schön klingt.“ \emph{Damit ich nicht selbst in dieselbe Falle tappe, was auch immer es ist.}
...
„Es war das, was man tat, wenn man in Gryffindor war“, sagte Remus langsam, widerwillig.
„Und … ich dachte damals nicht so, ich dachte, es wäre umgekehrt, aber … es könnte \emph{Black} gewesen sein, der \emph{James} da reingebracht hat, wirklich … Black wollte allen so sehr zeigen, dass er gegen Slytherin war, verstehst du, wir alle wollten glauben, dass Blut nicht Schicksal ist —“
...
„Ich weiß nicht, warum Black hinter Peter her war, anstatt wegzulaufen. Es war, als würde Black an diesem Tag eine Tragödie um der Tragödie willen begehen.“ Die Stimme des Mannes war unsicher.
„Es gab keinen Hinweis, keine Warnung, wir dachten alle — zu denken, dass er es sein würde —“ Remus’ Stimme brach ab.
...
Harry weinte, er konnte nicht anders, es tat schlimmer weh, es von Remus zu hören, als alles, was er je selbst gefühlt hatte. Harry hatte zwei Eltern verloren, an die er sich nicht erinnerte, die er nur aus Geschichten kannte. Remus Lupin hatte alle vier seiner besten Freunde in weniger als vierundzwanzig Stunden verloren; und für den Verlust seines letzten verbliebenen Freundes, Peter Pettigrew, hatte es einfach keinen Grund gegeben.
...
„Ich bin froh, Harry, dass Todesser keine Besucher empfangen dürfen. Das bedeutet, dass ich mich nicht schämen muss, nicht hinzugehen.“
...
„Können Sie mir von Peter Pettigrew erzählen? Er war der Freund meines Vaters, und es scheint — dass ich es wissen sollte, dass ich mich erinnern sollte —“
...
Remus nickte, Tränen glitzerten jetzt in seinen eigenen Augen.
„Ich denke, Harry, wenn Peter gewusst hätte, dass es so enden würde —“ die Stimme des Mannes erstickte. „Peter hatte mehr Angst vor dem Dunklen Lord als jeder von uns, und wenn er gewusst hätte, dass es so enden würde, hätte er es nicht getan. Aber Peter kannte das \emph{Risiko}, Harry, er wusste, dass das Risiko real war, dass es passieren \emph{könnte}, und doch blieb er an der Seite von James und Lily. Während meiner ganzen Zeit in Hogwarts fragte ich mich, warum Peter nicht nach Slytherin oder vielleicht Ravenclaw sortiert worden war, weil Peter so sehr Geheimnisse liebte, dass er ihnen nicht widerstehen konnte, er fand Dinge über Menschen heraus, Dinge, die sie verborgen halten wollten —“ Ein kurzer schiefer Blick huschte über Remus’ Gesicht. „Aber er hat diese Geheimnisse nicht \emph{benutzt}, Harry. Er wollte sie nur kennen. Und dann fiel der Schatten des Dunklen Lords über alles, und Peter stand zu James und Lily und setzte seine Talente zum Guten ein, und ich verstand, warum der Hut ihn nach Gryffindor geschickt hatte.“ Remus’ Stimme war jetzt grimmig und stolz.
„Es ist \emph{einfach}, zu seinen Freunden zu stehen, wenn man ein Held wie Godric ist, mutig und stark, wie die Leute denken, dass Gryffindors sein sollten. Aber wenn Peter mehr Angst hatte als wir alle, macht ihn das dann nicht auch zum Mutigsten?“
...
„Das tut es“, sagte Harry. Seine eigene Stimme war so erstickt, dass er kaum sprechen konnte.
„Wenn Sie könnten, Mr~Lupin, wenn Sie Zeit haben, gibt es noch jemanden, der die Geschichte von Peter Pettigrew hören sollte, einen Schüler aus Hufflepuff im ersten Jahr namens Neville Longbottom.“
...
„Alice und Franks Junge“, sagte Remus, seine Stimme wurde traurig.
„Ich verstehe. Es ist keine glückliche Geschichte, Harry, aber ich kann sie noch einmal erzählen, wenn du denkst, dass sie ihm helfen wird.“
...
„Hatte Black \emph{irgendein} unerledigtes Geschäft mit Peter Pettigrew?“ sagte Harry.
„\emph{Irgendetwas}, das ihn dazu bringen würde, Mr~Pettigrew aufzusuchen, auch wenn es keine tödliche Angelegenheit war? Wie ein Geheimnis, das Mr~Pettigrew kannte, das Black selbst wissen wollte oder ihn töten wollte, um es zu verbergen?“

% Something flickered in Remus’s eyes, but the older man shook his head, and said, “Not really.”
Etwas flackerte in Remus’ Augen, aber der ältere Mann schüttelte den Kopf und sagte:
„Nicht wirklich.“
...
Dieses schiefe Lächeln erschien wieder unter dem graumelierten Schnurrbart.
„Du hast selbst ein wenig von Peter in dir, wie ich sehe. Aber es ist nicht wichtig, Harry.“
...
„Ich bin ein Ravenclaw, es wird nicht von mir erwartet, der Versuchung von Geheimnissen zu widerstehen. Und“, sagte Harry ernster, „wenn es wert war, dass Black erwischt wurde, kann ich nicht anders, als zu denken, dass es wichtig sein könnte.“
...
„Ich könnte es dir sagen, wenn du älter bist, aber wirklich, Harry, es ist \emph{nicht} wichtig! Nur etwas aus unserer Schulzeit.“
...
Harry konnte nicht genau sagen, was ihn darauf gebracht hatte; es könnte etwas an dem genauen Ton der Nervosität in Remus’ Stimme gewesen sein oder die Art, wie der Mann \emph{wenn du älter bist} gesagt hatte, was Harrys plötzlichen Geistesblitz auslöste …

% “Actually,” said Harry, “I think I’ve sort of guessed it already, sorry.”
„Eigentlich“, sagte Harry,
„Ich glaube, ich habe es schon erraten, tut mir leid.“
...
„Einmal“, sagte Remus. „Vor langer Zeit. Eine traurige Angelegenheit, die in einem gewaltigen Unheil endete, oder so schien es uns allen, als wir jung waren.“ Die unglückliche Verwirrung war deutlich auf seinem Gesicht zu sehen. „Aber ich hatte gedacht, dass das längst vorbei und erledigt und unter erwachsener Freundschaft begraben war, bis zu dem Tag, an dem Black Peter tötete.“