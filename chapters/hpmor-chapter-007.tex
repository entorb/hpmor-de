...
„Wow“, sagte Harry. Robert Cialdinis \emph{Einfluss: Theorie und Praxis} kam dagegen wohl nicht an (obwohl es ein wahnsinnig gutes Buch war).\translatorsnote{Robert Cialdini: "Beeinflussung: Theorie und Praxis"\\ Eigentlich heißt das Buch Influence: Science and Practice (und ist auf deutsch, soweit ich weiß, noch nicht erschienen.) Falls jemand sich dafür interessiert, empfehle ich, in der örtlichen Bibliothek nach dem Buch "Einfluss. Wie und warum sich Menschen überzeugen lassen" (ebenfalls von Cialdini) zu fragen.} „Dein Vater ist fast so toll wie mein Vater.“
...
„Gib mir den \emph{Elevator Pitch}.\translatorsnote{(aus dem Englischen: "elevator" = Fahrstuhl, "pitch" = Verkaufsgespräch)\\ Stell dir vor, du arbeitest in einer großen Firma und brütest seit langem über einer großen Idee. Eines Tages stehst du zufällig mit dem Firmenchef im Aufzug und hast wenige Stockwerke Zeit, ihn von deiner Idee zu überzeugen …} Die Dreißig-Sekunden-Version, meine ich.“
