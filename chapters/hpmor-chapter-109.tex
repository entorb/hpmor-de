...
„Nimm jetzt deinen Umhang ab“, befahl Professor Quirrells Stimme, die immer noch aus dem Zaubertrankraum kam.
...
„Das weiß niemand, Mr~Potter.“ Der Verteidigungsprofessor streckte seine Finger nach den Runen aus, ein Ausdruck von so etwas wie Ehrfurcht auf seinem Gesicht; aber seine Finger berührten das Gold nicht.
...
Harry wusste, was die Rune für noitilov bedeutete. Sie bedeutete noitilov. Und die nächsten Runen sagten, man solle den Noitilov bis zum Partxe auflösen, dann den Teil behalten, der sowohl tnere als auch hoc war. Dieser Glaube fühlte sich wie Wissen an, als hätte er mit sicherer Autorität
„Ja“ antworten können, wenn ihn jemand gefragt hätte, ob die Tonne wo ruoy oder becafruoy war. Es war nur so, dass Harry, wenn er versuchte, diese Begriffe mit anderen Begriffen in Verbindung zu bringen, ins Leere lief.

% “\parsel{Do you understand what words mean, boy?}”
„\parsel{Verstehst du, was Worte bedeuten, Junge?}“
...
„Ich hatte mich gefragt, ob die Worte des falschen Verständnisses vielleicht für einen Muggel-Schüler verständlich sein könnten. Offenbar nicht.“
...
„Lass uns also als ersten Versuch — wenn auch nicht als letzten, sei versichert — sehen, was dieser Spiegel von deinem Versuch hält, den Stein zurückzuholen, um das Leben von Hermine Granger und Hunderten Ihrer Mitschüler zu retten.“
...
„Ähm“, sagte Harry.
„Du glaubst, dass dieser Spiegel eine Falle für dich ist —“
...
„Nun, am ersten Donnerstag dieses Jahres sagte mir der verrückte Schulleiter Dumbledore, den ich gerade gesehen hatte, wie er ein Huhn verbrannte, dass ich keinerlei Chance hätte, in seinen verbotenen Korridor zu gelangen, da ich den Zauberspruch \spell{Alohomora} nicht kenne.“
...
„Ich bin mir nicht sicher, warum du glaubst, dass dieses Rätsel lösbar ist“, sagte Harry.
...
„Mh“, sagte Harry.
„Vielleicht ist die Regel, dass die Person den Stein überhaupt nicht benutzen wollen muss — nein, das ist zu einfach, die Geschichte, die du Mr~Nott gegeben hast, löst das Problem.“
...
„Perenelle hat so lange gelebt, weil sie ihre Grenzen kennt“, sagte Professor Quirrell.
...
Harry legte auf Anweisung von Professor Quirrell den Tarnumhang an, um zu verhindern, \parsel{dass der Mann, der sich für sSchulleiter hält, dich sieht,} wie Professor Quirrell in Parsel sagte.
...
Und dann sagte Professor Quirrell: \spell{Confundus}
