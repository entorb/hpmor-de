...
Das erschien Harry sehr unwahrscheinlich, es sei denn, auf dieser Welt gab es furchterregende Wesen, die von David Criswells Starlifting-Ideen gelesen hatten.\translatorsnote{Starlifting: Sammelbegriff für verschiedene Techniken, mithilfe derer eine technologisch weit fortgeschrittene Zivilisation Material aus Sternen entfernen und für andere Zwecke verwenden könnte. (Siehe Wikipedia: \url{https://de.wikipedia.org/wiki/Star-Lifting})}
