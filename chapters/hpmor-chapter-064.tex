% Quelle der Übersetzung (ausgeklammert): https://www.fanfiktion.de/s/60044849000ccc541aef297e/64/
% Quelle der Übersetzung (nicht ausgeklammert): https://www.fanfiktion.de/s/5c793dfe000a402030774dc7/32/
...
\footnotetext{Dies hat nun eine erweiterte Fanfiction inspiriert, , \emph{Lighting Up the Dark} von Velorien. Auf Englisch hier zu finden: \url{https://www.fanfiction.net/s/9311012/1/Lighting-Up-the-Dark}}

% \textbf{DAS DORF IN DER KLARHEIT}
% \textbf{DAS DORF VERSTECKT IN DER KLARHEIT}
...
\clearpage
\OmakeIVsection{Erdős in Ketten}
...
\clearpage
\OmakeIVsection[1.2]{He-Man und die Meister der Rationalität}
...
\OmakeIVsection{Der Name der Rationalität}
...
\OmakeIVsection{Tengen Toppa Gurren Rationalität 40k}
...
\OmakeIVspecialsection{\fontspec[ExternalLocation]{Twilight}UTILITARISTISCHES
Twilight\protect\footnotemark}
% \OmakeIVspecialsection{\fontspec[ExternalLocation]{Twilight}Utilitarian
Twilight\protect\footnotemark}
% \textbf{UTILITARIAN TWILIGHT}
% \textbf{UTILITARISTISCHES ZWIELICHT}
...
% \OmakeIVsection{Jasmin und die Lampe}
...
\OmakeIVsection[1.2]{Rationalist Hamlet\protect\footnotemark}%

beigetragen von \emph{Histocrat} auf LiveJournal, Beitrag 13389, alias \emph{HonoreDB} auf LessWrong(mit Erlaubnis wiederveröffentlicht)
...
\footnotetext{HonoreDB hat dies nun zu einem kompletten ebook erweitert mit dem Titel \emph{A Will Most Incorrect to Heaven: The Tragedy of Prince Hamlet and the Philosopher’s Stone}, erhältlich für \$3 bei \url{http://makefoil.com/}. Ja, wirklich.}
...
\OmakeIVsection{Moby Dick und die Methoden der Rationalität}
...
\OmakeIVsection[0.9]{Alice im Land wo verrücktere Sachen als hier passieren}
