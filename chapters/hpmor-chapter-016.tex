...
Auf einem leicht erhöhten Podium aus dunklerem Marmor in der Mitte der riesigen Bühne befand sich ein einsamer Lehrertisch. Dahinter saß Quirrell in seinem Stuhl zusammengesunken, der Kopf im Nacken, mit dünnen Spuckefäden auf seinem Umhang.
...
Harry wählte einen Tisch, kletterte zu ihm hoch, setzte sich und holte das Verteidigungs-Lehrbuch hervor. Er hatte es zu sieben Achteln durchgelesen — eigentlich wollte er das Buch vor dieser Unterrichtsstunde durchgelesen haben, doch er war etwas im Rückstand und hatte den Zeitumkehrer heute schon zweimal benutzt.
...
Einer von den Jungen, die hinter Draco standen, schien recht viele Muskeln für einen Elfjährigen zu haben, der andere verharrte in einer verdächtig ausbalanciert wirkenden Haltung.
...
Der weißblonde Junge lächelte recht selbstgefällig und deutete hinter sich.
...
„Freut mich, dich kennenzulernen“ in einer Tonlage, die klang, als versuchte er so tief zu sprechen, wie er nur konnte.

% A fleeting expression of consternation crossed Draco’s face, but was quickly replaced by his superior grin.
Kurz flackerte Bestürzung auf Dracos Gesicht auf, wurde jedoch schnell von seinem überheblichen Grinsen verdrängt.
...
„Und“, sagte Harry,
„Lucius hat darauf bestanden, dass du \emph{nicht} mit deinen Leibwächtern aufwächst und ihnen erst am ersten Schultag begegnen solltest.“
...
„Ich bitte um Entschuldigung“, sagte Draco steif, „für die Beleidigung, die dir diese \emph{Vollidioten} angetan haben.“
...
Harry sah Mr~Crabbe und Mr~Goyle vielsagend an.
...
„\emph{Gryffindorks!}“ spie Draco aus.
...
„Hm“, sagte Harry.
„Professor Quirrell hat gesagt … ich weiß nicht mehr genau, wie er es formuliert hat …, dass er einige der Hogwarts-Unterrichtskonventionen missachten würde. Vielleicht hat er einfach den Unterricht aller vier Häuser zusammengelegt.“
...
„Hast du ihn mit einem Kuchen beworfen?“
...
„Dass er in Wirklichkeit gar nichts Durchtriebenes und Ehrgeiziges tut und dass er eine Schande für Salazar Slytherin ist.“ Draco starrte Harry eindringlich an.
...
„Ich glaube, es war eher so etwas wie ‚Ist das hier irgendein unglaublich cleverer Plan, der euch irgendwelche zukünftigen Vorteile bescheren wird, oder ist es wirklich eine so große Schande für das Andenken Salazar Slytherins, wie es aussieht?‘, oder so ähnlich. Ich erinnere mich nicht mehr an die genaue Wortwahl.“
...
Mr~Crabbe und Mr~Goyle kicherten beide, woraufhin Mr~Goyle sich sehr schnell eine Hand vor den Mund schlug.
...
„Mal sehen, ob ich meine Schulbücher ebenso schnell lesen kann wie Hermine Granger.“
...
\emph{Oh, das wird} so \emph{viel Spaß machen, damit zu jonglieren, das merke ich jetzt schon.}
...
„Macht euch nicht die Mühe aufzuschreiben, wie dieses Fach einst genannt wurde. Keine derart sinnlosen Fragen werden in meinem Unterricht zu eurer Note beitragen. Das verspreche ich.“
...
Professor Quirrell lächelte sehr grimmig.
„Das sogenannte Verteidigungs-Lehrbuch für Drittklässler sagt euch, dass man den Bergtroll dem Sonnenlicht aussetzen soll, woraufhin er an Ort und Stelle erstarren lässt. Dies, meine jungen Lehrlinge, ist genau das nutzlose Wissen, welches ihr in meinem Unterricht nie zu Ohren bekommen werdet. Man trifft Bergtrolle nicht am helllichten Tag an! Die Idee, man solle Sonnenlicht benutzen, um sie aufzuhalten, entstammt dem Versuch der Lehrbuchschreiber, zulasten praktischer Belange mit ihrem Detailwissen zu prahlen. Nur weil es eine lächerlich obskure Möglichkeit gibt, sich mit Bergtrollen auseinanderzusetzen, bedeutet das nicht, dass ihr sie tatsächlich ausprobieren solltet! Der Todesfluch ist unaufhaltsam, unabwendbar und funktioniert jedes Mal bei allem, was ein Gehirn besitzt. Wenn ihr euch als erwachsene Zauberer nicht in der Lage seht, einen Todesfluch zu sprechen, dann könnt ihr einfach weg apparieren! Das Gleiche gilt, wenn ihr der zweitbesten Tötungsmaschine der Welt gegenübersteht, einem Dementor. Ihr appariert einfach weg!“
...
Professor Quirrells Lippen bildeten eine dünne Linie.
...
Professor Quirrell machte eine schneidende Geste und der Applaus erstarb sofort.
...
„Ja, ihr habt mich richtig verstanden. Ich werde euch das Kämpfen lehren, nicht zwölf Zoll über das Kämpfen zu schreiben, fällig am Montag.“
...
„Bing“ von der schwebenden blauen Kugel, die Professor Quirrell Harry als Ziel zugewiesen hatte. Genau dieses Geräusch stand für einen perfekten Treffer, den Harry nun in neun der letzten zehn Versuche geschafft hatte.
...
Ein \emph{roter Energieblitz} schoss aus seinem Zauberstab und traf das Ziel und die blaue Kugel machte wieder
...
Zum ersten Mal, seit er in Hogwarts angekommen war, fühlte Harry sich wie ein richtiger Zauberer. Er wünschte, das Ziel würde ausweichen, so wie die kleinen Kugeln, die Ben Kenobi benutzt hatte, um Luke zu trainieren, aber aus irgendeinem Grund hatte Professor Quirrell alle Schüler und Ziele fein säuberlich in Reihen aufgestellt, sodass sie sich nicht gegenseitig trafen.
...
Das hohe
„Bing“ was daraufhin ertönte, war eines der zufriedenstellendsten Geräusche, die er jemals in seinem Leben gehört hatte. Harry wollte triumphierend und so laut er konnte schreien: \emph{\scream{Ich kann zaubern! Fürchtet mich, Naturgesetze, ich komme, um euch zu verletzen!}}
...
„— und anschließend sieben anderen Schülern geholfen hat, wofür sie die ersten sieben Quirrell-Punkte verdient hat, die ich in eurem Jahrgang vergebe. Treten Sie vor, Hermine Granger, es wird Zeit für die nächste Stufe des Spiels.“
...
Hermine Granger schritt mit einer Mischung aus Triumph und Besorgnis im Gesicht vor. Die Ravenclaws sahen stolz zu, die Slytherins mit finsteren Blicken, und Harry einfach nur genervt. Harry hatte sich diesmal gut geschlagen. Jetzt, da alle mit einem ihnen gleichermaßen unbekannten Zauber konfrontiert worden waren, und da Harry Adalbert Wafflings \emph{Magical Theory} durchgelesen hatte, gehörte er vermutlich sogar zur besseren Hälfte der Klasse. Und Hermine \emph{war immer noch besser.}

% Somewhere in the back of his mind was the fear that Hermione was simply smarter than him.
Irgendwo tief in seinem Inneren hegte er die Befürchtung, dass Hermine einfach klüger als er sein könnte.
...
Doch erst einmal würde Harry seine Hoffnungen darauf stützen, dass (a) Hermine weit mehr als nur die vorgegebenen Lehrbücher gelesen hatte und (b) Adalbert Waffling ein uninspirierter Langweiler war, der \emph{Magical Theory} geschrieben hatte, um damit einen Schulbeirat zu beeindrucken, der nicht viel von Elfjährigen hielt.
...
„Nun denn“, sagte Professor Quirrell ruhig.
...
Hermines Gesicht war angstverzerrt und ihr Zauberstab zitterte in ihrer Hand. Harrys eigene Finger umklammerten seinen eigenen Zauberstab und zitterten vor Mitgefühl. Obwohl er verstand, was Professor Quirrell vorhatte. Obwohl er begriff, welchen Punkt Professor Quirrell damit verdeutlichen wollte.
...
„Es ist also klar, dass Hermine Granger nicht die gefährlichste Schülerin im Raum ist. Wer, glaubt ihr, könnte tatsächlich die gefährlichste Person im Raum sein? Abgesehen von mir, natürlich.“
...
Harry hätte versucht, ihn aufzuhalten, wenn er Zeit gehabt hätte, doch in einer einzigen nahtlosen Bewegung drehte sich Draco zu den Ravenclaws, erhob seinen Zauberstab und sagte \spell{Mahasu}, als ob es eine einzige Silbe wäre, und Hermine sagte
...
Draco verbeugte sich leicht und ging zurück zu der Gruppe von Slytherins. Einige von ihnen begannen zu klatschen, doch Professor Quirrell machte eine schneidende Geste und es wurde wieder still.
...
Ein Adrenalinstoß durchfuhr Harry und er stellte sich aufrechter hin. Er wusste nicht, zu welchem Schluss Professor Quirrell gekommen war, aber es konnte kein guter sein.
...
Professor Quirrell wirkte amüsiert.
„Du glaubst, dass ich zu einer falschen Antwort gekommen bin, nicht wahr, Mr~Potter? Du wirst lernen, von \emph{mir} mehr zu erwarten.“ Professor Quirrell, der sich an den Tisch gelehnt hatte, stand auf.
„Mr~Potter, alle Gegenstände haben einen gewöhnlichen Zweck. Nenne mir zehn ungewöhnliche Verwendungen von Gegenständen in diesem Raum für den Kampf!“
...
Dann sprudelten die Ideen aus ihm heraus.
...
„Das sind zehn, obwohl ich gnädig bin, wenn ich den Ravenclaw mitzähle. Als Bonus nun einen Quirrell-Punkt für jede Verwendung eines Gegenstands in diesem Raum, den Sie noch nicht genannt haben.“ Professor Quirrell schenkte Harry ein kameradschaftliches Lächeln.
...
„Meine Armbanduhr könnte jemanden ersticken, wenn man sie ihm in die Kehle stopft —“
...
„Sagt es bitte laut. Terry Boot, was macht deinen Schlafsaalkameraden gefährlich?“
...
„Mr~Potters Ideen waren allesamt schlimmer als nutzlos!“

% Harry started in surprise.
Harry fuhr überrascht zusammen.
...
„Den Boden entfernen, um eine stachelbesetzte Grube zu schaffen? Lächerlich! Im Kampf haben Sie nicht genügend Vorbereitungszeit, und selbst wenn Sie die hätten, gäbe es hundert bessere Verwendungen! Material aus den Wänden transfigurieren? Mr~Potter beherrscht keine Verwandlung! Mr~Potter hatte genau eine Idee, die er hier und jetzt anwenden könnte, ohne aufwändige Vorbereitung, ohne einen kooperativen Gegner und ohne Magie, die er nicht kennt. Diese Idee war, seinen Zauberstab einem Gegner durch die Augenhöhle zu rammen. Was eher seinen Zauberstab beschädigen als seinen Gegner töten würde! Kurz gesagt, Mr~Potter, ich fürchte, dass Ihre Vorschläge allesamt miserabel waren.“
...
„Mr~Potter, ich habe nie gesagt, dass Sie \emph{töten} sollten. Es gibt Zeit und Ort, den Gegner lebend zu nehmen, und ein Hogwarts-Klassenzimmer ist in der Regel einer dieser Orte. Aber um Ihre Frage zu beantworten: Schlag ihm mit der Kante eines Stuhls auf den Nacken.“
...
„Aber Mr~Potter hat nun demonstriert, warum er der gefährlichste Schüler im Klassenzimmer ist. Ich habe nach ungewöhnlichen Verwendungen von Gegenständen in diesem Raum während eines Kampfes. Mr~Potter hätte vorschlagen können, mit einem Tisch einen Fluch abzublocken oder einen näherkommenden Gegner mit einem Stuhl zum Fallen zu bringen oder Stoff um seinen Arm zu wickeln, um ein Schild zu improvisieren. Stattdessen war jeder von Mr~Potters Vorschlägen offensiv statt defensiv und entweder tödlich oder möglicherweise tödlich.“
...
„Und deswegen“, sagte Professor Quirrell, „waren Mr~Potters Ideen so seltsam und nutzlos — weil er Ideen an den Haaren herbeiziehen musste, um seinem Maßstab \emph{den Gegner zu töten} zu genügen. Für ihn war jede Idee, die dahinter zurückblieb, nicht der Erwägung wert. Das spiegelt eine Eigenschaft wider, die wir als \emph{Tötungsabsicht} bezeichnen könnten. Ich habe sie. Harry Potter hat sie, deshalb konnte er fünf älteren Slytherins die Stirn bieten. Draco Malfoy hat sie nicht — noch nicht. Mr~Malfoy würde kaum davor zurückschrecken, von gewöhnlichem Mord zu sprechen, doch selbst er war schockiert — ja, das waren Sie, Mr~Malfoy, ich habe Ihr Gesicht beobachtet — als Mr~Potter beschrieb, wie die Körper seiner Klassenkameraden als Rohmaterial genutzt werden könnten. Ihr habt Sittenrichter in euren Köpfen, die euch vor solchen Gedanken zurückschrecken lassen. Mr~Potter denkt \emph{ausschließlich} daran, den Gegner zu töten, ihm ist jedes Mittel dafür recht, er schreckt nicht zurück, seine Sittenrichter sind still. Obwohl sein jugendliches Genie so undiszipliniert und unpraktisch denkt, dass es nutzlos ist, macht seine \emph{Tötungsabsicht} Harry Potter zum gefährlichsten Schüler im Klassenzimmer. Ein letzter Punkt für ihn — nein, machen wir daraus lieber einen Punkt für Ravenclaw — für diese unverzichtbare Voraussetzung eines wahren Kampfmagiers.“
...
Aber er konnte sehen, dass die anderen Schüler anfingen, es zu glauben. Harrys Gehirn ging mögliche Widersprüche durch und fand nichts, was gegen die Ehrfurcht gebietende Stimme von Professor Quirrell ankommen konnte. Das Beste, was Harry einfiel, war
...
„Ich sehe, wir müssen alle irgendwo anfangen. Mr~Potter, wählen Sie irgendeinen Schüler aus, auf den Sie einen Simplen Schlagzauber sprechen. Sie \emph{werden} das tun, bevor ich die heutige Unterrichtsstunde beende. Wenn nicht, werde ich anfangen, Hauspunkte abzuziehen, und solange weitermachen, bis Sie es tun.“
...
„Warum zögern sie?“, sagte Professor Quirrell.
...
Nein. Inakzeptabel. Sie mussten \emph{dringend} miteinander reden. Zum Teufel mit dieser Zombie-Nummer, Professor Quirrell würde vermutlich aufwachen, wenn Harry ihn einige Male anstupste. Harry schritt vorwärts —
...
Harry schwankte und blieb stehen, ihm war schwindelig.
